// ignore_for_file: library_private_types_in_public_api, use_key_in_widget_constructors, prefer_const_constructors, deprecated_member_use, unnecessary_new, prefer_const_literals_to_create_immutables
      ...
      connectivityBuilder: (
        ...
        if (connectivity == ConnectivityResult.none) {
          final appBar = AppBar(
              ...
              title: Text(
                AppLocalizations.of(context)!.translate('matrix'),
                style: TextStyle(
