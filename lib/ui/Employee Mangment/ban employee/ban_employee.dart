// ignore_for_file: prefer_const_literals_to_create_immutables, prefer_const_constructors, unused_local_variable, use_build_context_synchronously, must_be_immutable, non_constant_identifier_names
...
class BanEmployee extends StatefulWidget {
  int userId;
  bool is_block;
  BanEmployee({
    Key? key,
  ...
  @override
  State<BanEmployee> createState() => _BanEmployeeState();
}

class _BanEmployeeState extends State<BanEmployee> {
          ...
          child: Column(
            ...
            children: [
              ...
              _isLoading
                  ...
                  : Center(
                      child: SmallText(
                        text: widget.is_block
                            ? AppLocalizations.of(context)!.translate(
                                "are you sure for activate this employee")
                            : AppLocalizations.of(context)!
                                .translate("are you sure for ban employee"),
        ...
        _isLoading
            ...
            : CustomButton(
                ...
                width:
                    MediaQuery.of(context).size.width / 2.272727272727273, //165
                btnLbl: "موافق",
                onPressedFunction: banEmployeeMethed,
  ...
  banEmployeeMethed() async {
    ...
    final response = await post(
      Uri.parse(widget.is_block
          ? "${Urls.BAN_USER_URLL}active/${widget.userId}"
          : "${Urls.BAN_USER_URLL}block/${widget.userId}"),
          ...
          builder: (context) {
            return Container(
              ...
              child: successOperation(
                operationName: widget.is_block
                    ? "Active employee successfully"
                    : "ban employee successfully",
              ),
            );
          });
      setState(() {
