// ignore_for_file: prefer_const_constructors, deprecated_member_use, sized_box_for_whitespace, prefer_const_literals_to_create_immutables, prefer_final_fields, unused_field, prefer_interpolation_to_compose_strings, unused_element, non_constant_identifier_names, use_build_context_synchronously, unused_local_variable, unnecessary_brace_in_string_interps
...
import 'package:cayan/ui/Employee%20Mangment/add%20employee/add%20employee%20screen/add_employee.dart';
import 'package:cayan/ui/Employee%20Mangment/setting%20employee%20body/setting_employee_body.dart';
...
class EmployeeMangementScreen extends StatefulWidget {
  const EmployeeMangementScreen({Key? key}) : super(key: key);

  @override
  State<EmployeeMangementScreen> createState() =>
      _EmployeeMangementScreenState();
}

class _EmployeeMangementScreenState extends State<EmployeeMangementScreen> {
  ...
  void dispose() {
    ...
    _searchController.removeListener(_loadMore);
    clientApi.close();
  }
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: BigText(
              typeOfFontWieght: 1,
              text: AppLocalizations.of(context)!
                  .translate("Employees Management"),
            ),
            leading: Builder(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    editEmployee(
                      ...
                      ///
                      searchController.text == ""
                          ? _allUsers[index]["country"]["code"] ?? ""
                          : _searchedResult[index]["country"]["code"] ?? "",
                      ...
                      ///
                      searchController.text == ""
                          ? _allUsers[index]["role_id"] ?? 0
                          : _searchedResult[index]["role_id"] ?? 0,
                    ...
                    setState(() {
                      ...
                      UserData.setEditEmloyeeCountryId(
                        searchController.text == ""
                            ? _allUsers[index]["country"]["id"]
                            : _searchedResult[index]["country"]["id"],
                      );
                      ...
                      UserData.setEditEmployeePermissionsId(
                          searchController.text == ""
                              ? _allUsers[index]["role_id"]
                              : _searchedResult[index]["role_id"]);
  ...
  searchUserApicall(String value) async {
    ...
    final response = await clientApi.get(
        Uri.parse(
          "${Urls.GRT_ALL_USER_URL}${searchPage}&name=${value}",
        ),
        headers: <String, String>{
          'Accept': 'application/json',
          "Accept-Language": UserData.getUSerLang(),
  ...
  void _SearchMore() async {
    ...
    if (_hasNextPage == true &&
      ...
      final response = await clientApi.get(
          Uri.parse(
            "${Urls.GRT_ALL_USER_URL}${searchPage}&name=${searchContent}",
          ),
          headers: <String, String>{
            'Accept': 'application/json',
            "Accept-Language": UserData.getUSerLang(),
