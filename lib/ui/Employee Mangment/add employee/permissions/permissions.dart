// ignore_for_file: prefer_const_literals_to_create_immutables, prefer_const_constructors, prefer_final_fields, unused_field, unused_local_variable, use_build_context_synchronously, sized_box_for_whitespace
      ...
      child: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() {
                UserData.setPermissionsId(_allPermissions[index]["id"] ?? "");
              ...
              children: [
                Container(
                  ...
                  child: SmallText(
                    ...
                    typeOfFontWieght: UserData.getPermissionsId() ==
                ...
                Expanded(
                  child: Row(
                    ...
                    children: [
                      Visibility(
                          visible: UserData.getPermissionsId() ==
                                  _allPermissions[index]["id"]
                              ? true
                              : false,
