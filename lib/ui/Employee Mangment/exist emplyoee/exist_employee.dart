// ignore_for_file: prefer_const_literals_to_create_immutables, prefer_const_constructors, unused_element, unused_local_variable, non_constant_identifier_names, use_build_context_synchronously, must_be_immutable
...
class ExistEmployee extends StatefulWidget {
  int userId;
  ExistEmployee({Key? key, required this.userId}) : super(key: key);

  @override
  State<ExistEmployee> createState() => _ExistEmployeeState();
}

class _ExistEmployeeState extends State<ExistEmployee> {
                  ...
                  : Center(
                      child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("are you sure for exsit employee"),
        ...
        _isLoading
            ...
            : CustomButton(
                ...
                width:
                    MediaQuery.of(context).size.width / 2.272727272727273, //165
                btnLbl: "موافق",
                onPressedFunction: existEmployeeMethed,
  ...
  existEmployeeMethed() async {
    ...
    final response = await post(
      Uri.parse("${Urls.EXIST_EMPLOYEE_URL}${widget.userId}"),
          ...
          builder: (context) {
            return Container(
              ...
              child: successOperation(
                  operationName: "log out employee successfully"),
            );
          });
      setState(() {
        _isLoading = false;
