...
import 'package:cayan/ui/Branches/add%20branch/add_branche.dart';
import 'package:cayan/ui/Branches/setting%20branche/setting_branche.dart';
...
class BrancheScreen extends StatefulWidget {
  const BrancheScreen({Key? key}) : super(key: key);
...
class _BrancheScreenState extends State<BrancheScreen> {
              ...
              InkWell(
                onTap: () {
                  _settingBranche(
                    ...
                    searchController.text == ""
                        ? _allUsers[index]["translations"]["ar"]["city"] ?? ""
                        : _searchedResult[index]["translations"]["ar"]
                                ["city"] ??
                            "",
                    ...
                    searchController.text == ""
                        ? _allUsers[index]["translations"]["en"]["city"] ?? ""
                        : _searchedResult[index]["translations"]["en"]
                                ["city"] ??
                            "",
                    ...
                    searchController.text == ""
                        ? _allUsers[index]["translations"]["ar"]["address"] ??
                            ""
                        : _searchedResult[index]["translations"]["ar"]
                                ["address"] ??
                            "",
                    ...
                    searchController.text == ""
                        ? _allUsers[index]["translations"]["en"]["address"] ??
                            ""
                        : _searchedResult[index]["translations"]["en"]
                                ["address"] ??
                            "",
                    ...
                    searchController.text == ""
                        ? _allUsers[index]["telephone"] ?? ""
                        : _searchedResult[index]["telephone"] ?? "",

                    searchController.text == ""
                        ? _allUsers[index]["whatsapp"] ?? ""
                        : _searchedResult[index]["whatsapp"] ?? "",

                    searchController.text == ""
                        ? _allUsers[index]["map"] ?? ""
                        : _searchedResult[index]["map"] ?? "",
                ...
                child: Padding(
                  padding: EdgeInsets.only(
                    ...
                    right: UserData.getUSerLang() == "en"
                        ? MediaQuery.of(context).size.width / 23.4375
                        : 0,
                    bottom: MediaQuery.of(context).size.height / 16.24,
                  ),
          ...
          Center(
            child: Container(
              ...
              child: SmallText(
                maxLine: 2,
                text: searchController.text == ""
                    ? _allUsers[index]["full_description"] ?? ""
                    : _searchedResult[index]["full_description"] ?? "",
                color: searchController.text == ""
                    ? _allUsers[index]["is_block"] == true
                        ? redColor
                        : textGrayColor
  ...
  searchUserApicall(String value) async {
    ...
    final response = await clientApi.get(
        Uri.parse(
          "${Urls.GET_BRANCHES_URL}${searchPage}&name=${value}",
        ),
        headers: <String, String>{
          'Accept': 'application/json',
          "Accept-Language": UserData.getUSerLang(),
  ...
  void _SearchMore() async {
    ...
    if (_hasNextPage == true &&
      ...
      final response = await clientApi.get(
          Uri.parse(
            "${Urls.GET_BRANCHES_URL}${searchPage}&name=${searchContent}",
          ),
          headers: <String, String>{
            'Accept': 'application/json',
            "Accept-Language": UserData.getUSerLang(),
    ...
    return showModalBottomSheet(
        ...
        builder: (context) {
          return Container(
            padding: EdgeInsets.only(
                bottom: MediaQuery.of(context).viewInsets.bottom),
            child: SettingBranche(
              userId: userId,
              userArbicName: userArbicName,
              userEnglisName: userEnglisName,
              cityArbicName: cityArbicName,
              cityEnglishName: cityEnglishName,
              adressArbicName: adressArbicName,
              adressEnglishName: adressEnglishName,
