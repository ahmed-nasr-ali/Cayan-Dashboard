...
class AddBranche extends StatefulWidget {
  ...
  @override
  State<AddBranche> createState() => _AddBrancheState();
}
                          ...
                          : Padding(
                              ...
                              child: SmallText(
                                text: AppLocalizations.of(context)!.translate(
                                  "Fill in the following data to create a new branche",
                                ),
                                size: MediaQuery.of(context).size.height /
                                    58, //14
                              ),
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffix: false,
                                isSuffixImage: false,
                                hintText: "المدينه باللغة العربية",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
                                    return AppLocalizations.of(context)!
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffix: false,
                                isSuffixImage: false,
                                hintText: "العنوان بالغة العربيه",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
                                    return AppLocalizations.of(context)!
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffixImage: false,
                                hintText:
                                    "الوصف الوصف التفصيلي للفرع باللغة العربية",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
          ...
          _isLoading
              ...
              : CustomButton(
                  ...
                  width: MediaQuery.of(context).size.width /
                      2.272727272727273, //165
                  btnLbl: "حفظ",
                  onPressedFunction: _addBrancheMehode,
              ...
              builder: (context) {
                return Container(
                  ...
                  child: successOperation(
                      operationName: "add new branche successfully"),
                );
              });
        });
        setState(() {
