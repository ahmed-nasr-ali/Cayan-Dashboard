...
class DeleteBranche extends StatefulWidget {
  int userId;
  DeleteBranche({Key? key, required this.userId}) : super(key: key);

  @override
  State<DeleteBranche> createState() => _DeleteBrancheState();
}

class _DeleteBrancheState extends State<DeleteBranche> {
                  ...
                  : Center(
                      child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Are you sure form deleting branche"),
  ...
  deleteServicesMethed() async {
    ...
    final response = await delete(
      Uri.parse("${Urls.EDIT_BRANCHE_URL}${widget.userId}"),
          ...
          builder: (context) {
            return Container(
              ...
              child: successOperation(
                  operationName: "delete branche successfully"),
            );
          });
      setState(() {
        _isLoading = false;
