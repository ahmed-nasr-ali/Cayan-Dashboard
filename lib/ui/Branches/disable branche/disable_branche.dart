// ignore_for_file: prefer_final_fields, unused_field, must_be_immutable, unused_local_variable, prefer_const_constructors, use_build_context_synchronously, non_constant_identifier_names
...
class DisableBranche extends StatefulWidget {
  int userId;
  bool is_block;
  ...
  @override
  State<DisableBranche> createState() => _DisableBrancheState();
}

class _DisableBrancheState extends State<DisableBranche> {
                  ...
                  : Center(
                      child: SmallText(
                        text: AppLocalizations.of(context)!.translate(
                          widget.is_block == true
                              ? "Are you sure form activate this branche"
                              : "Are you sure form blocking branche",
                        ),
        ...
        _isLoading
            ...
            : CustomButton(
                ...
                width:
                    MediaQuery.of(context).size.width / 2.272727272727273, //165
                btnLbl: "موافق",
                onPressedFunction: disableBrancheMethed,
  ...
  disableBrancheMethed() async {
    ...
    final response = await put(
      Uri.parse(widget.is_block == true
          ? "${Urls.EDIT_BRANCHE_URL}${widget.userId}/active"
          : "${Urls.EDIT_BRANCHE_URL}${widget.userId}/block"),
            ...
            return Container(
              ...
              child: successOperation(
                  operationName: widget.is_block == true
                      ? "Active branche successfully"
                      : "ban branche successfully"),
            );
          });
      setState(() {
        _isLoading = false;
