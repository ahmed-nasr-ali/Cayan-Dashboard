// ignore_for_file: unused_field, prefer_final_fields, use_build_context_synchronously, unused_element, unused_local_variable, prefer_const_constructors, prefer_const_literals_to_create_immutables, unnecessary_brace_in_string_interps, non_constant_identifier_names, sized_box_for_whitespace
...
import 'package:cayan/ui/Projects/add%20project/add_project.dart';
import 'package:cayan/ui/Projects/setting%20projects/srtting_project.dart';
...
class _ProjectScreenState extends State<ProjectScreen> {
      ...
      child: PageContainer(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: BigText(
              typeOfFontWieght: 1,
              text: AppLocalizations.of(context)!.translate("projects"),
            ),
            leading: Builder(
          ...
          Padding(
            ...
            child: Container(
              ...
              child: SmallText(
                ...
                text: searchController.text == ""
                    ? _allUsers[index]["classification"] ?? ""
                    : _searchedResult[index]["classification"] ?? "",
                color: themeProvider.isDarkMode
                    ? searchController.text == ""
                        ? _allUsers[index]["is_block"] == true
                            ? redColor
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    height:
                        MediaQuery.of(context).size.height / 54.13333333333333,
                  )
                ],
              ),
            ),
  ...
  searchUserApicall(String value) async {
    ...
    final response = await clientApi.get(
        Uri.parse(
          "${Urls.GET_PROJECT_URL}${searchPage}&name=${value}",
        ),
        headers: <String, String>{
          'Accept': 'application/json',
          "Accept-Language": UserData.getUSerLang(),
  ...
  void _SearchMore() async {
    ...
    if (_hasNextPage == true &&
      ...
      final response = await clientApi.get(
          Uri.parse(
            "${Urls.GET_PROJECT_URL}${searchPage}&name=${searchContent}",
          ),
          headers: <String, String>{
            'Accept': 'application/json',
            "Accept-Language": UserData.getUSerLang(),
    ...
    return showModalBottomSheet(
        ...
        builder: (context) {
          return Container(
              padding: EdgeInsets.only(
                  bottom: MediaQuery.of(context).viewInsets.bottom),
              child: SettingProject(
                userId: userId,
                userArbicName: userArbicName,
                userEnglisName: userEnglisName,
                userArbicclassification: userArbicclassification,
                userEnglisclassification: userEnglisclassification,
                userShortArbicDescription: userShortArbicDescription,
                userShortEnglisDescription: userShortEnglisDescription,
                userArbicFullDescription: userArbicFullDescription,
                userEnglisFullDescription: userEnglisFullDescription,
                userimage: userimage,
                is_block: is_block,
              ));
        });
