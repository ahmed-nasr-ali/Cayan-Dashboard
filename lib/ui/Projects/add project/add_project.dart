                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffix: false,
                                isSuffixImage: false,
                                hintText: "اسم المشروع باللغة العربيه",
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffix: false,
                                isSuffixImage: false,
                                hintText: " تصنيف المشروع بالغة العربيه",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
                                    return AppLocalizations.of(context)!
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffix: false,
                                isSuffixImage: false,
                                hintText: "Classification project in English",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
                                    return AppLocalizations.of(context)!
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffix: false,
                                isSuffixImage: false,
                                hintText: "وصف مختصر للمشروع بالغة العربية",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
                                    return AppLocalizations.of(context)!
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffixImage: false,
                                hintText:
                                    "Short description of the project in Englis ",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
                                    return AppLocalizations.of(context)!
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffix: false,
                                isSuffixImage: false,
                                hintText: "وصف تفصيلي للمشروع بالغة العربية",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
                                    return AppLocalizations.of(context)!
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffixImage: false,
                                hintText:
                                    "Detailed description of the prject in Englis ",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
                                    return AppLocalizations.of(context)!
          ...
          _isLoading
              ...
              : CustomButton(
                  ...
                  width: MediaQuery.of(context).size.width /
                      2.272727272727273, //165
                  btnLbl: "حفظ",
                  onPressedFunction: addProjectMethod,
              ...
              builder: (context) {
                return Container(
                  ...
                  child: successOperation(
                      operationName: "add new project successfully"),
                );
              });
        });
        setState(() {
