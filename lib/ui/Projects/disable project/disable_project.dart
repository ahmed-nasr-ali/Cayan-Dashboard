...
class DisableProject extends StatefulWidget {
  int userId;
  bool is_block;
  DisableProject({
    Key? key,
  ...
  @override
  State<DisableProject> createState() => _DisableProjectState();
}

class _DisableProjectState extends State<DisableProject> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      child: SmallText(
                        text: widget.is_block == true
                            ? AppLocalizations.of(context)!.translate(
                                "Are you sure form Activation this project",
                              )
                            : AppLocalizations.of(context)!.translate(
                                "Are you sure form blocking project",
                              ),
  ...
  disableServicesMethed() async {
    ...
    final response = await put(
      Uri.parse(widget.is_block == true
          ? "${Urls.DELETE_Project_URL}${widget.userId}/active"
          : "${Urls.DELETE_Project_URL}${widget.userId}/block"),
