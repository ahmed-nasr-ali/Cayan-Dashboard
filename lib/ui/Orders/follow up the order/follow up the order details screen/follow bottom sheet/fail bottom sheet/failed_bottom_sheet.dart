// ignore_for_file: unused_local_variable, avoid_print, use_build_context_synchronously, non_constant_identifier_names, sized_box_for_whitespace
...
class FailedBottomSheet extends StatefulWidget {
  const FailedBottomSheet({Key? key}) : super(key: key);

  @override
  State<FailedBottomSheet> createState() => _FailedBottomSheetState();
}

class _FailedBottomSheetState extends State<FailedBottomSheet> {
  ...
  Future fetchCategoryList() async {
    ...
    final response = await clientApi.get(
      Uri.parse("${Urls.GET_SUB_STATUS_URL}4/substatuses"),
  ...
  Widget build(BuildContext context) {
    ...
    return NetworkIndicator(
      child: Container(
        height: MediaQuery.of(context).size.height / 1.691666666666667, //480
          ...
          children: [
            ...
            _isLoading
                ...
                : Padding(
                    ...
                    child: SmallText(
                      text: AppLocalizations.of(context)!.translate("Why"),
                ...
                : Padding(
                    ...
                    child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Why did the request fail?")),
                  ),
            SizedBox(
