// ignore_for_file: unused_local_variable, unused_field, prefer_final_fields, use_build_context_synchronously, non_constant_identifier_names, sized_box_for_whitespace
...
class PaidBottomSheet extends StatefulWidget {
  const PaidBottomSheet({Key? key}) : super(key: key);

  @override
  State<PaidBottomSheet> createState() => _PaidBottomSheetState();
}

class _PaidBottomSheetState extends State<PaidBottomSheet> {
  ...
  Future fetchCategoryList() async {
    ...
    final response = await clientApi.get(
      Uri.parse("${Urls.GET_SUB_STATUS_URL}3/substatuses"),
      ...
      child: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() {
                OrderUserData.setOrderSubStatusId(_allUsers[index]["id"] ?? 0);
