// ignore_for_file: prefer_const_literals_to_create_immutables, prefer_final_fields, unused_field, use_build_context_synchronously, non_constant_identifier_names, prefer_const_constructors, sized_box_for_whitespace
...
class CustomerCaseBottomSheet extends StatefulWidget {
  const CustomerCaseBottomSheet({Key? key}) : super(key: key);

  @override
  State<CustomerCaseBottomSheet> createState() =>
      _CustomerCaseBottomSheetState();
}

class _CustomerCaseBottomSheetState extends State<CustomerCaseBottomSheet> {
  ...
  Future fetchCategoryList() async {
    ...
    final response = await clientApi.get(
      Uri.parse("${Urls.GET_SUB_STATUS_URL}2/substatuses"),
  ...
  Widget build(BuildContext context) {
    ...
    return NetworkIndicator(
      child: Container(
        height: MediaQuery.of(context).size.height / 2.460606060606061, //430
          ...
          children: [
            ...
            _isLoading
                ...
                : Padding(
                    ...
                    child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Choose the status of the customer")),
                  ),
            SizedBox(
      ...
      child: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() {
                OrderUserData.setOrderSubStatusId(_allUsers[index]["id"] ?? "");
              ...
              children: [
                Container(
                  ...
                  child: SmallText(
                    ...
                    typeOfFontWieght: OrderUserData.getOrderSubStatusId() ==
                            _allUsers[index]["id"]
                        ? 1
                        : 0,
                    color: themeProvider.isDarkMode ? whiteColor : blackColor,
                ...
                Expanded(
                  child: Row(
                    ...
                    children: [
                      Visibility(
                          visible: OrderUserData.getOrderSubStatusId() ==
                                  _allUsers[index]["id"]
                              ? true
                              : false,
