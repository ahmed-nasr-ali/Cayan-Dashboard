// ignore_for_file: unused_local_variable, unused_field, prefer_final_fields, use_build_context_synchronously, unused_element, prefer_const_literals_to_create_immutables, non_constant_identifier_names, prefer_const_constructors, sized_box_for_whitespace
          ...
          children: [
            ...
            _isLoading
                ...
                : Padding(
                    ...
                    child: SmallText(
                      text: AppLocalizations.of(context)!.translate("Client"),
            ...
            _isLoading
                ...
                : Padding(
                    ...
                    child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Choose from the following clients")),
                  ),
            SizedBox(
      ...
      child: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() {
                OrderUserData.setCustomerId(_allUsers[index]["id"] ?? "");
                OrderUserData.setCustomerName(_allUsers[index]["name"] ?? "");
              });
            ...
            child: Row(
              children: [
                Container(
                  width: MediaQuery.of(context).size.width / 1.875, //200
                  child: SmallText(
                    align: TextAlign.start,
                    text: _allUsers[index]["name"] ?? "",
                    size: MediaQuery.of(context).size.height / 50.75, //14
                    typeOfFontWieght:
                        OrderUserData.getCustomerId() == _allUsers[index]["id"]
                            ? 1
                            : 0,
                    color: themeProvider.isDarkMode ? whiteColor : blackColor,
                  ),
                ...
                Expanded(
                  child: Row(
                    ...
                    children: [
                      Visibility(
                          visible: OrderUserData.getCustomerId() ==
                                  _allUsers[index]["id"]
                              ? true
                              : false,
