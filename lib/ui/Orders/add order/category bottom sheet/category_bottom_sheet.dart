// ignore_for_file: unused_field, prefer_final_fields, avoid_print, use_build_context_synchronously, unused_local_variable, prefer_const_literals_to_create_immutables, non_constant_identifier_names, sized_box_for_whitespace
      ...
      child: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() {
                OrderUserData.setCategoryId(_allUsers[index]["id"] ?? "");
                OrderUserData.setCategoryName(_allUsers[index]["name"] ?? "");
              });
              Navigator.pop(context);
            },
            child: Row(
              children: [
                Container(
                  ...
                  child: SmallText(
                    ...
                    typeOfFontWieght:
                        OrderUserData.getCategoryId() == _allUsers[index]["id"]
                            ? 1
                            : 0,
                    color: themeProvider.isDarkMode ? whiteColor : blackColor,
                  ),
                ...
                Expanded(
                  child: Row(
                    ...
                    children: [
                      Visibility(
                          visible: OrderUserData.getCategoryId() ==
                                  _allUsers[index]["id"]
                              ? true
                              : false,
