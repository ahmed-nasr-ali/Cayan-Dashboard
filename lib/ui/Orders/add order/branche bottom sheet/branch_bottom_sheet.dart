// ignore_for_file: unused_local_variable, prefer_const_literals_to_create_immutables, use_build_context_synchronously, prefer_const_constructors, non_constant_identifier_names, sized_box_for_whitespace
...
class BranchesBottomSheet extends StatefulWidget {
  const BranchesBottomSheet({Key? key}) : super(key: key);
          ...
          children: [
            ...
            _isLoading
                ...
                : Padding(
                    ...
                    child: SmallText(
                      text: AppLocalizations.of(context)!.translate("Branche"),
            ...
            _isLoading
                ...
                : Padding(
                    ...
                    child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Choose from the following branches")),
                  ),
            SizedBox(
      ...
      child: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() {
                OrderUserData.setBrancheId(_allUsers[index]["id"] ?? "");
                OrderUserData.setBrancheName(_allUsers[index]["name"] ?? "");
              });
              ...
              children: [
                Container(
                  ...
                  child: SmallText(
                    ...
                    typeOfFontWieght:
                        OrderUserData.getBrancheId() == _allUsers[index]["id"]
                            ? 1
                            : 0,
                    color: themeProvider.isDarkMode ? whiteColor : blackColor,
                  ),
                ...
                Expanded(
                  child: Row(
                    ...
                    children: [
                      Visibility(
                          visible: OrderUserData.getBrancheId() ==
                                  _allUsers[index]["id"]
                              ? true
                              : false,
