// ignore_for_file: prefer_final_fields, unused_field, unused_local_variable, must_be_immutable, prefer_const_constructors, use_build_context_synchronously, non_constant_identifier_names
...
class DisableCustomerReview extends StatefulWidget {
  int userId;
  bool is_block;
  ...
  @override
  State<DisableCustomerReview> createState() => _DisableCustomerReviewState();
}

class _DisableCustomerReviewState extends State<DisableCustomerReview> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      child: SmallText(
                        text: widget.is_block == true
                            ? AppLocalizations.of(context)!.translate(
                                "Are you sure form Activation this Customer")
                            : AppLocalizations.of(context)!.translate(
                                "Are you sure form blocking Customert"),
        ...
        _isLoading
            ...
            : CustomButton(
                ...
                width:
                    MediaQuery.of(context).size.width / 2.272727272727273, //165
                btnLbl: "موافق",
                onPressedFunction: disableServicesMethed,
  ...
  disableServicesMethed() async {
    ...
    final response = await put(
      Uri.parse(widget.is_block == true
          ? "${Urls.DELETE_CUSTOMER_REVIEW_URL}${widget.userId}/active"
          : "${Urls.DELETE_CUSTOMER_REVIEW_URL}${widget.userId}/block"),
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (_) => customerReviewsScreen()));
            ...
            return AlertDialog(
              ...
              title: BigText(
                ...
                text: AppLocalizations.of(context)!
                    .translate("can not disable this service"),
                typeOfFontWieght: 1,
              ),
            );
          });
