// ignore_for_file: prefer_const_constructors, must_be_immutable, unused_local_variable, avoid_print, use_build_context_synchronously
...
class DeleteCustomerReview extends StatefulWidget {
  int userId;
  DeleteCustomerReview({Key? key, required this.userId}) : super(key: key);

  @override
  State<DeleteCustomerReview> createState() => _DeleteCustomerReviewState();
}

class _DeleteCustomerReviewState extends State<DeleteCustomerReview> {
                  ...
                  : Center(
                      child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Are you sure form deleting Customer"),
        ...
        _isLoading
            ...
            : CustomButton(
                ...
                width:
                    MediaQuery.of(context).size.width / 2.272727272727273, //165
                btnLbl: "موافق",
                onPressedFunction: deleteServicesMethed,
  ...
  deleteServicesMethed() async {
    ...
    final response = await delete(
      Uri.parse("${Urls.DELETE_CUSTOMER_REVIEW_URL}${widget.userId}"),
          ...
          builder: (context) {
            return Container(
              ...
              child: successOperation(
                  operationName: "delete service successfully"),
            );
          });
      setState(() {
        _isLoading = false;
          ...
          builder: (context) {
            return AlertDialog(
              ...
              title: BigText(
                color: blackColor,
                text: AppLocalizations.of(context)!
                    .translate("can not delete this service"),
                typeOfFontWieght: 1,
              ),
            );
          });
