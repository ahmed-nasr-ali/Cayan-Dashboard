// ignore_for_file: must_be_immutable, unused_field, prefer_final_fields, prefer_const_literals_to_create_immutables, prefer_const_constructors, unnecessary_string_interpolations, unused_element, nullable_type_in_catch_clause, unused_catch_clause, empty_catches, non_constant_identifier_names, no_leading_underscores_for_local_identifiers, sized_box_for_whitespace, prefer_if_null_operators, unused_local_variable, use_build_context_synchronously
...
class EditCustomerReview extends StatefulWidget {
  int userId;
  String userimage;
  String userName;
  String userJob;
  ...
  @override
  State<EditCustomerReview> createState() => _EditCustomerReviewState();
}

class _EditCustomerReviewState extends State<EditCustomerReview> {
  File? imageSend;
  ...
  void initState() {
    ...
    _userComment.text = "${widget.userComment} ";

    _userJob.text = "${widget.userJob} ";
  }
                          ...
                          : Padding(
                              ...
                              child: SmallText(
                                text: AppLocalizations.of(context)!.translate(
                                  "edit custome and change his information",
                                ),
                                size: MediaQuery.of(context).size.height /
                                    58, //14
                              ),
          ...
          _isLoading
              ...
              : CustomButton(
                  ...
                  width: MediaQuery.of(context).size.width /
                      2.272727272727273, //165
                  btnLbl: "حفظ",
                  onPressedFunction: editCustomerReview,
  ...
  editCustomerReview() async {
    ...
    if (formKey.currentState!.validate()) {
      ...
      final response = await Dio().post(
        ("${Urls.ADD_CUSTOMER_REVIEW_URL}/${widget.userId}"),
        data: formData,
        options: Options(
              ...
              builder: (context) {
                return Container(
                  ...
                  child: successOperation(
                      operationName: "edit new customer successfully"),
                );
              });
        });
        setState(() {
