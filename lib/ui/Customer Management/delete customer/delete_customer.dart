// ignore_for_file: prefer_const_constructors, prefer_final_fields, must_be_immutable, avoid_print, use_build_context_synchronously
...
class _DeleteCustomerState extends State<DeleteCustomer> {
                ...
                : Center(
                    child: SmallText(
                      text: AppLocalizations.of(context)!
                          .translate("Are you sure form deleting custommer"),
  ...
  deleteBlog() async {
    ...
    final response = await delete(
      Uri.parse("${Urls.DELETE_CUSTOMER_URL}${widget.id}"),
          ...
          builder: (context) {
            return Container(
              ...
              child: successOperation(
                  operationName: "Delete customer successfully"),
            );
          });
      setState(() {
        _isLoading = false;
