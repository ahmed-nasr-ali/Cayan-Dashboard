// ignore_for_file: non_constant_identifier_names, must_be_immutable, unused_field, prefer_final_fields, unused_local_variable, prefer_const_literals_to_create_immutables, prefer_const_constructors, nullable_type_in_catch_clause, no_leading_underscores_for_local_identifiers, sized_box_for_whitespace, prefer_if_null_operators, unnecessary_string_interpolations, use_build_context_synchronously, unused_catch_clause, empty_catches
...
class _EditBlogState extends State<EditBlog> {
  ...
  void initState() {
    ...
    _blogNameArbic.text = "${widget.userArbicTitle} ";
    _blogNameEnglish.text = "${widget.userEnglisTitle} ";

    _blogDescribtionArbic.text = "${widget.userArbicDescription} ";
    _blogDescribtionEnglish.text = "${widget.userEnglisDescription} ";

    blogShortDescribtionArbic.text = "${widget.userShortArbicDescription} ";
    blogShortDescribtionEnglish.text = "${widget.userShortEnglisDescription} ";
    _blogCartLink.text = "${widget.reference_link} ";
  }
                        ...
                        : Padding(
                            ...
                            child: SmallText(
                              text: AppLocalizations.of(context)!.translate(
                                "Edit the article and change its data",
                              ),
                              size:
                    ...
                    _isLoading
                        ...
                        : Padding(
                            ...
                            child: CustomTextField(
                              ...
                              isSuffix: false,
                              isSuffixImage: false,
                              hintText: widget.userArbicTitle,
                              inputData: TextInputType.name,
                              onChangedFunc: (value) {
                                if (value == " ") {
                                  setState(() {
                                    _blogNameArbic.clear();
                                  });
                                }
                              },
                    ...
                    _isLoading
                        ...
                        : Padding(
                            ...
                            child: CustomTextField(
                              ...
                              isSuffix: false,
                              isSuffixImage: false,
                              hintText: widget.userEnglisTitle,
                              inputData: TextInputType.name,
                              onChangedFunc: (value) {
                                if (value == " ") {
                                  setState(() {
                                    _blogNameEnglish.clear();
                                  });
                                }
                              },
                              validationFunc: (value) {
                    ...
                    _isLoading
                        ...
                        : Padding(
                            ...
                            child: CustomTextField(
                              ...
                              isSuffix: false,
                              isSuffixImage: false,
                              hintText: widget.reference_link,
                              inputData: TextInputType.name,
                              onChangedFunc: (value) {
                                if (value == " ") {
                                  setState(() {
                        ...
                        : Padding(
                            ...
                            child: CustomTextField(
                              ...
                              onChangedFunc: (value) {
                                if (value == " ") {
                                  setState(() {
                                    blogShortDescribtionArbic.clear();
                                  });
                                }
                              },
                              validationFunc: (value) {
                        ...
                        : Padding(
                            ...
                            child: CustomTextField(
                              ...
                              onChangedFunc: (value) {
                                if (value == " ") {
                                  setState(() {
                                    blogShortDescribtionEnglish.clear();
                                  });
                                }
                              },
                              validationFunc: (value) {
                              ...
                              onTap: () {
                                setState(() {
                                  _blogFouceEnglishShortDescribtion.hasFocus ==
                                      true;
                                });
                              },
                              onEditingComplete: () =>
                    ...
                    _isLoading
                        ...
                        : Padding(
                            ...
                            child: CustomTextField(
                              ...
                              onTap: () {
                                setState(() {
                                  _blogFouceEnglishDescribtion.hasFocus == true;
                                });
                              },
                              onEditingComplete: () =>
                                  _blogFouceEnglishDescribtion.unfocus(),
  ...
  addBlogMethod() async {
    ...
    if (formKey.currentState!.validate()) {
      ...
      final response = await Dio().post(
        ("${Urls.EDIT_BLOGS_URL}${widget.userId}"),
        data: formData,
        options: Options(
              ...
              builder: (context) {
                return Container(
                  ...
                  child: successOperation(
                      operationName: "edit new Blog successfully"),
                );
              });
        });
        setState(() {
