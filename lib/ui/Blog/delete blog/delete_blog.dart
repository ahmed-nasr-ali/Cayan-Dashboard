...
class DeleteBlog extends StatefulWidget {
  int id;
  DeleteBlog({
    Key? key,
    required this.id,
  ...
  @override
  State<DeleteBlog> createState() => _DeleteBlogState();
}

class _DeleteBlogState extends State<DeleteBlog> {
                  ...
                  : Center(
                      child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Are you sure form deleting Blog"),
  ...
  deleteBlog() async {
    ...
    final response = await delete(
      Uri.parse("${Urls.DELETE_BLOG_URLL}${widget.id}"),
      ...
      showModalBottomSheet(
          ...
          builder: (context) {
            return Container(
              ...
              child:
                  successOperation(operationName: "Delete Blog successfully"),
            );
          });
      setState(() {
        _isLoading = false;
