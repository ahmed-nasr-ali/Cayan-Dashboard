// ignore_for_file: unused_field, prefer_final_fields, must_be_immutable, unused_local_variable, prefer_const_constructors, use_build_context_synchronously, non_constant_identifier_names
...
class DisableSource extends StatefulWidget {
  int userId;
  bool is_block;
  DisableSource({
    Key? key,
  ...
  @override
  State<DisableSource> createState() => _DisableSourceState();
}

class _DisableSourceState extends State<DisableSource> {
                      ...
                      child: SmallText(
                        text: AppLocalizations.of(context)!.translate(
                            widget.is_block == true
                                ? "Are you sure form Active this source"
                                : "Are you sure form blocking source"),
        ...
        _isLoading
            ...
            : CustomButton(
                ...
                width:
                    MediaQuery.of(context).size.width / 2.272727272727273, //165
                btnLbl: "موافق",
                onPressedFunction: disableSourceMethed,
  ...
  disableSourceMethed() async {
    ...
    final response = await put(
      Uri.parse(widget.is_block == true
          ? "${Urls.EDIT_SOURCE_URL}${widget.userId}/active"
          : "${Urls.EDIT_SOURCE_URL}${widget.userId}/block"),
            ...
            return Container(
              ...
              child: successOperation(
                operationName: widget.is_block == true
                    ? "Active source successfully"
                    : "ban source successfully",
              ),
            );
          });
      setState(() {
