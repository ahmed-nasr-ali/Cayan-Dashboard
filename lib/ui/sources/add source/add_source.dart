// ignore_for_file: prefer_const_constructors, unused_field, prefer_final_fields, unused_local_variable, prefer_const_literals_to_create_immutables, unnecessary_string_interpolations, unused_element, non_constant_identifier_names, no_leading_underscores_for_local_identifiers, prefer_if_null_operators, use_build_context_synchronously, sized_box_for_whitespace, unused_catch_clause, empty_catches
                          ...
                          : Padding(
                              ...
                              child: SmallText(
                                text: AppLocalizations.of(context)!.translate(
                                  "Fill in the following data to create a new source",
                                ),
                                size: MediaQuery.of(context).size.height /
                                    58, //14
                              ),
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffix: false,
                                isSuffixImage: false,
                                hintText: "Decribtion in english",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
                                    return AppLocalizations.of(context)!
          ...
          _isLoading
              ...
              : CustomButton(
                  ...
                  width: MediaQuery.of(context).size.width /
                      2.272727272727273, //165
                  btnLbl: "حفظ",
                  onPressedFunction: addOfferMethod,
              ...
              builder: (context) {
                return Container(
                  ...
                  child: successOperation(
                      operationName: "add new source successfully"),
                );
              });
        });
        setState(() {
