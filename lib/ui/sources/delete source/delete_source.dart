...
class DeleteSource extends StatefulWidget {
  int userId;
  DeleteSource({Key? key, required this.userId}) : super(key: key);

  @override
  State<DeleteSource> createState() => _DeleteSourceState();
}

class _DeleteSourceState extends State<DeleteSource> {
                  ...
                  : Center(
                      child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Are you sure form deleting source"),
  ...
  deleteServicesMethed() async {
    ...
    final response = await delete(
      Uri.parse("${Urls.EDIT_SOURCE_URL}${widget.userId}"),
      ...
      showModalBottomSheet(
          ...
          builder: (context) {
            return Container(
              ...
              child:
                  successOperation(operationName: "delete source successfully"),
            );
          });
      setState(() {
        _isLoading = false;
