// ignore_for_file: must_be_immutable, unused_field, prefer_final_fields, prefer_const_literals_to_create_immutables, prefer_const_constructors, non_constant_identifier_names, no_leading_underscores_for_local_identifiers, prefer_if_null_operators, sized_box_for_whitespace, unused_local_variable, use_build_context_synchronously, unnecessary_string_interpolations, empty_catches, unused_catch_clause
...
import 'package:cayan/ui/Services/edit%20service/edit%20category%20bottom%20sheet/edit_category_bottom_sheet.dart';
...
class _EditServiceState extends State<EditService> {
  ...
  void initState() {
    ...
    _serviceNameArbic.text = "${widget.userArbicName} ";
    _serviceNameEnglish.text = "${widget.userEnglisName} ";

    _serviceeDescribtionArbic.text = "${widget.userArbicDescription} ";
    _serviceeDescribtionEnglish.text = "${widget.userEnglisDescription} ";
  }
                ...
                Column(
                  ...
                  children: [
                        ...
                        : Padding(
                            ...
                            child: SmallText(
                              text: AppLocalizations.of(context)!.translate(
                                "edit service and change his information",
                              ),
                              size:
                    ...
                    _isLoading
                        ...
                        : _dimenssion(themeProvider, "service name in arabic"),
                    _isLoading
                        ? Padding(
                            padding: EdgeInsets.symmetric(
                                horizontal:
                              ...
                              validationFunc: (value) {
                                if (value!.isEmpty) {
                                  ...
                                  return AppLocalizations.of(context)!
                                      .translate("servicies name is required");
                                }
                                return null;
                              },
                              onTap: () {
                    ...
                    _isLoading
                        ...
                        : _dimenssion(themeProvider, "service name in english"),
                    _isLoading
                        ? Padding(
                            padding: EdgeInsets.symmetric(
                                horizontal:
                            ...
                            child: CustomContainer(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  SmallText(
                                    text: ServicesUserData.getCategoryName() ??
                                        "",
                                    color:
                                        isSelected ? mainAppColor : hintColor,
                                    size:
                        ...
                        : Padding(
                            ...
                            child: CustomTextField(
                              ...
                              onChangedFunc: (value) {
                                if (value == " ") {
                                  setState(() {
                                    _serviceeDescribtionArbic.clear();
                                  });
                                }
                              },
                              validationFunc: (value) {
                        ...
                        : Padding(
                            ...
                            child: CustomTextField(
                              ...
                              onChangedFunc: (value) {
                                if (value == " ") {
                                  setState(() {
                                    _serviceeDescribtionEnglish.clear();
                                  });
                                }
                              },
                              validationFunc: (value) {
          ...
          _isLoading
              ...
              : CustomButton(
                  ...
                  width: MediaQuery.of(context).size.width /
                      2.272727272727273, //165
                  btnLbl: "حفظ",
                  onPressedFunction: editServiceMethod,
  ...
  editServiceMethod() async {
    ...
    if (formKey.currentState!.validate()) {
      ...
      if (response.statusCode == 200) {
        setState(() {
          ServicesUserData.setEditCategoryId(0);
              ...
              builder: (context) {
                return Container(
                  ...
                  child: successOperation(
                      operationName: "edit new service successfully"),
                );
              });
        });
        setState(() {
