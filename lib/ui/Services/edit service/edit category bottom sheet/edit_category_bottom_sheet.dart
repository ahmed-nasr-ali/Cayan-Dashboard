// ignore_for_file: unused_field, use_build_context_synchronously, unused_local_variable, non_constant_identifier_names
      ...
      child: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() {
                ServicesUserData.setEditCategoryId(_allUsers[index]["id"]);
            ...
            child: Row(
              children: [
                SmallText(
                  ...
                  typeOfFontWieght: ServicesUserData.getEditCategoryId() ==
                          _allUsers[index]["id"]
                      ? 1
                      : 0,
                  color: themeProvider.isDarkMode ? whiteColor : blackColor,
                ...
                Expanded(
                  child: Row(
                    ...
                    children: [
                      Visibility(
                          visible: ServicesUserData.getEditCategoryId() ==
                                  _allUsers[index]["id"]
                              ? true
                              : false,
