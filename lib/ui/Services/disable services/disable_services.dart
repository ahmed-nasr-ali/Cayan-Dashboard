...
class DisableService extends StatefulWidget {
  int userId;
  bool is_block;
  DisableService({
    Key? key,
  ...
  @override
  State<DisableService> createState() => _DisableServiceState();
}

class _DisableServiceState extends State<DisableService> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      child: SmallText(
                        text: widget.is_block == true
                            ? AppLocalizations.of(context)!.translate(
                                "Are you sure form Activation this service")
                            : AppLocalizations.of(context)!.translate(
                                "Are you sure form blocking service"),
  ...
  disableServicesMethed() async {
    ...
    final response = await put(
      Uri.parse(widget.is_block == true
          ? "${Urls.DISABLE_SERVICE_URL}${widget.userId}/active"
          : "${Urls.DISABLE_SERVICE_URL}${widget.userId}/block"),
            ...
            return Container(
              ...
              child: successOperation(
                  operationName: widget.is_block == true
                      ? "Activate service successfully"
                      : "ban service successfully"),
            );
          });
      setState(() {
        _isLoading = false;
