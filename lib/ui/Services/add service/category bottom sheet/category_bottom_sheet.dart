// ignore_for_file: unused_local_variable, prefer_const_literals_to_create_immutables, prefer_final_fields, non_constant_identifier_names, unused_field, use_build_context_synchronously, unused_element, prefer_const_constructors
...
class CategroyBottomSheet extends StatefulWidget {
  const CategroyBottomSheet({Key? key}) : super(key: key);

  @override
  State<CategroyBottomSheet> createState() => _CategroyBottomSheetState();
}

class _CategroyBottomSheetState extends State<CategroyBottomSheet> {
  ...
  Future fetchCategoryList() async {
    ...
    final response = await clientApi.get(
      Uri.parse(Urls.ADD_CATEGORY_URL),
                ...
                : Padding(
                    ...
                    child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("choose from the following categories")),
                  ),
            SizedBox(
      ...
      child: Column(
        children: [
          ...
          InkWell(
            onTap: () {
              setState(() {
                ServicesUserData.setCategoryId(_allUsers[index]["id"]);
                ServicesUserData.setCategoryName(_allUsers[index]["name"]);
              });
              Navigator.pop(context);
            },
            child: Row(
              children: [
                SmallText(
                  ...
                  typeOfFontWieght:
                      ServicesUserData.getCategoryId() == _allUsers[index]["id"]
                          ? 1
                          : 0,
                  color: themeProvider.isDarkMode ? whiteColor : blackColor,
                ),
                Expanded(
                  child: Row(
                    ...
                    children: [
                      Visibility(
                          visible: ServicesUserData.getCategoryId() ==
                                  _allUsers[index]["id"]
                              ? true
                              : false,
