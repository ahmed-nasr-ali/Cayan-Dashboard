// ignore_for_file: prefer_const_constructors, unused_element, prefer_final_fields, unused_field, unused_local_variable, use_build_context_synchronously, prefer_const_literals_to_create_immutables, non_constant_identifier_names, sized_box_for_whitespace, prefer_interpolation_to_compose_strings, unnecessary_brace_in_string_interps
...
import 'package:cayan/ui/Services/add%20service/add_servcie.dart';
import 'package:cayan/ui/Services/setting%20services/setting_services.dart';
...
class _ServicesScreenState extends State<ServicesScreen> {
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    settingServices(
                      ...
                      ///
                      searchController.text == ""
                          ? _allUsers[index]["category"]["id"] ?? 0
                          : _searchedResult[index]["category"]["id"] ?? 0,
                      ...
                      ///
                      searchController.text == ""
                          ? _allUsers[index]["category"]["name"] ?? ""
                          : _searchedResult[index]["category"]["name"] ?? "",
                    );
                  },
                  child: Padding(
                    padding: EdgeInsets.only(
  ...
  searchUserApicall(String value) async {
    ...
    final response = await clientApi.get(
        Uri.parse(
          "${Urls.GET_SERVICERS_URL}${searchPage}&name=${value}",
        ),
        headers: <String, String>{
          'Accept': 'application/json',
          "Accept-Language": UserData.getUSerLang(),
  ...
  void _SearchMore() async {
    ...
    if (_hasNextPage == true &&
      ...
      final response = await clientApi.get(
          Uri.parse(
            "${Urls.GET_SERVICERS_URL}${searchPage}&name=${searchContent}",
          ),
          headers: <String, String>{
            'Accept': 'application/json',
            "Accept-Language": UserData.getUSerLang(),
