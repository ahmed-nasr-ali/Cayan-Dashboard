// ignore_for_file:  unused_field, prefer_final_fields, unused_local_variable, prefer_const_literals_to_create_immutables, prefer_const_constructors, nullable_type_in_catch_clause, no_leading_underscores_for_local_identifiers, non_constant_identifier_names, sized_box_for_whitespace, prefer_if_null_operators, unnecessary_string_interpolations, use_build_context_synchronously, must_be_immutable, unused_catch_clause, empty_catches
...
class EditTeamWorkMember extends StatefulWidget {
  int userId;
  String userName;
  ...
  @override
  State<EditTeamWorkMember> createState() => _EditTeamWorkMemberState();
}

class _EditTeamWorkMemberState extends State<EditTeamWorkMember> {
  File? imageSend;
  ...
  void initState() {
    ...
    _specialization.text = "${widget.userSpecialization} ";
  }
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffix: false,
                                isSuffixImage: false,
                                hintText: widget.userSpecialization,
                                inputData: TextInputType.name,
                                onChangedFunc: (value) {
                                  if (value == " ") {
                                    setState(() {
          ...
          _isLoading
              ...
              : CustomButton(
                  ...
                  width: MediaQuery.of(context).size.width /
                      2.272727272727273, //165
                  btnLbl: "حفظ",
                  onPressedFunction: editPersonMethod,
  ...
  editPersonMethod() async {
    ...
    if (formKey.currentState!.validate()) {
      ...
      final response = await Dio().post(
        ("${Urls.EDIT_TEAM_WORK_MEMBER_URL}${widget.userId}"),
        data: formData,
        options: Options(
              ...
              builder: (context) {
                return Container(
                  ...
                  child: successOperation(
                      operationName: "edit new member successfully"),
                );
              });
        });
        setState(() {
