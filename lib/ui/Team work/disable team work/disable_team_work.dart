// ignore_for_file: prefer_const_constructors, must_be_immutable, unused_local_variable, use_build_context_synchronously, non_constant_identifier_names
...
class DisableTeamWork extends StatefulWidget {
  int userId;
  bool is_block;
  ...
  @override
  State<DisableTeamWork> createState() => _DisableTeamWorkState();
}

class _DisableTeamWorkState extends State<DisableTeamWork> {
                    ...
                    child: SmallText(
                      text: widget.is_block == true
                          ? AppLocalizations.of(context)!
                              .translate("Are you sure form Active this member")
                          : AppLocalizations.of(context)!
                              .translate("Are you sure form blocking member"),
  ...
  banTeamWorkMemberMethed() async {
    ...
    final response = await put(
      Uri.parse(widget.is_block == true
          ? "${Urls.BAN_TEAM_WORK_MEMBER_URL}${widget.userId}/active"
          : "${Urls.BAN_TEAM_WORK_MEMBER_URL}${widget.userId}/block"),
