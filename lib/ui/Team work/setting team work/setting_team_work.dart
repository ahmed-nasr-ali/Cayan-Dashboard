...
import 'package:cayan/ui/Team%20work/delete%20team%20work/delete_team_work.dart';
import 'package:cayan/ui/Team%20work/disable%20team%20work/disable_team_work.dart';
import 'package:cayan/ui/Team%20work/edit%20team%20work%20member/edit_team_work_member.dart';
import 'package:cayan/utils/app_colors.dart';

class SettingTeamWork extends StatefulWidget {
  int userId;
  String userName;
  ...
  @override
  State<SettingTeamWork> createState() => _SettingTeamWorkState();
}

class _SettingTeamWorkState extends State<SettingTeamWork> {
  @override
  void initState() {
    super.initState();
  }
                  ...
                  showModalBottomSheet(
                      ...
                      builder: (context) {
                        return Container(
                          ...
                          child: EditTeamWorkMember(
                            userId: widget.userId,
                            userName: widget.userName,
                            userSpecialization: widget.userSpecialization,
