// ignore_for_file: prefer_const_constructors, unused_local_variable, prefer_const_literals_to_create_immutables, unused_element, prefer_final_fields, unused_field, use_build_context_synchronously, unnecessary_brace_in_string_interps, non_constant_identifier_names, sized_box_for_whitespace, prefer_interpolation_to_compose_strings
...
import 'package:cayan/ui/Team%20work/add%20team%20work%20member/add_team_work_member.dart';
import 'package:cayan/ui/Team%20work/setting%20team%20work/setting_team_work.dart';
...
class TeamWorkScreen extends StatefulWidget {
  const TeamWorkScreen({Key? key}) : super(key: key);

  @override
  State<TeamWorkScreen> createState() => _TeamWorkScreenState();
}

class _TeamWorkScreenState extends State<TeamWorkScreen> {
      ...
      child: PageContainer(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: BigText(
              typeOfFontWieght: 1,
              text: AppLocalizations.of(context)!.translate("team work"),
            ),
            leading: Builder(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    settingTeamWork(
                      ...
                      ///
                      searchController.text == ""
                          ? _allUsers[index]["specialization"] ?? ""
                          : _searchedResult[index]["specialization"] ?? "",
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    width: MediaQuery.of(context).size.width / 2.9296875, //128
                    height: MediaQuery.of(context).size.height /
  ...
  Widget listViewBody(int index, ThemeProvider themeProvider) {
    return Container(
      ...
      width: MediaQuery.of(context).size.width,
      height: MediaQuery.of(context).size.height / 7.25, //112
      decoration: BoxDecoration(
        color: themeProvider.isDarkMode ? containerdarkColor : whiteColor,
        borderRadius:
            BorderRadius.circular(MediaQuery.of(context).size.height / 81.2),
  ...
  searchUserApicall(String value) async {
    ...
    final response = await clientApi.get(
        Uri.parse(
          "${Urls.GRT_TEAM_WORK_URL}${searchPage}&name=${value}",
        ),
        headers: <String, String>{
          'Accept': 'application/json',
          "Accept-Language": UserData.getUSerLang(),
  ...
  void _SearchMore() async {
    ...
    if (_hasNextPage == true &&
      ...
      final response = await clientApi.get(
          Uri.parse(
            "${Urls.GRT_TEAM_WORK_URL}${searchPage}&name=${searchContent}",
          ),
          headers: <String, String>{
            'Accept': 'application/json',
            "Accept-Language": UserData.getUSerLang(),
