...
class DeletTeamWork extends StatefulWidget {
  int userId;

  DeletTeamWork({Key? key, required this.userId}) : super(key: key);

  @override
  State<DeletTeamWork> createState() => _DeletTeamWorkState();
}

class _DeletTeamWorkState extends State<DeletTeamWork> {
                  ...
                  : Center(
                      child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Are you sure form deleting member"),
        ...
        _isLoading
            ...
            : CustomButton(
                ...
                width:
                    MediaQuery.of(context).size.width / 2.272727272727273, //165
                btnLbl: "موافق",
                onPressedFunction: deleteMemberMethed,
  ...
  deleteMemberMethed() async {
    ...
    final response = await delete(
      Uri.parse("${Urls.DELETE_TEAM_WORK_MEMBER_URL}${widget.userId}"),
      ...
      showModalBottomSheet(
          ...
          builder: (context) {
            return Container(
              ...
              child:
                  successOperation(operationName: "delete member successfully"),
            );
          });
      setState(() {
        _isLoading = false;
          ...
          builder: (context) {
            return AlertDialog(
              ...
              title: BigText(
                color: blackColor,
                text: AppLocalizations.of(context)!
                    .translate("can not delete this member"),
                typeOfFontWieght: 1,
              ),
            );
          });
