// ignore_for_file: unused_field, prefer_final_fields, prefer_const_literals_to_create_immutables, prefer_const_constructors, prefer_if_null_operators, avoid_print, nullable_type_in_catch_clause, non_constant_identifier_names, no_leading_underscores_for_local_identifiers, unnecessary_string_interpolations, sized_box_for_whitespace, unused_local_variable, use_build_context_synchronously, unused_catch_clause, empty_catches
                        ...
                        : Padding(
                            ...
                            child: SmallText(
                              text: AppLocalizations.of(context)!.translate(
                                "Fill in the following data to create a new offer",
                              ),
                              size:
                    ...
                    _isLoading
                        ...
                        : Padding(
                            ...
                            child: CustomTextField(
                              ...
                              onTap: () {
                                setState(() {
                                  _offerFouceDescribtionArbic.hasFocus == true;
                                });
                              },
                              onEditingComplete: () =>
                                  _offerFouceDescribtionArbic.unfocus(),
              ...
              builder: (context) {
                return Container(
                  ...
                  child: successOperation(
                      operationName: "add new offer successfully"),
                );
              });
        });
        setState(() {
