// ignore_for_file: must_be_immutable, avoid_print, unused_local_variable, prefer_const_constructors, use_build_context_synchronously
...
class DeleteOffer extends StatefulWidget {
  int userId;
  DeleteOffer({
    Key? key,
  ...
  @override
  State<DeleteOffer> createState() => _DeleteOfferState();
}

class _DeleteOfferState extends State<DeleteOffer> {
                  ...
                  : Center(
                      child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Are you sure form deleting offer"),
  ...
  deleteOffer() async {
    ...
    final response = await delete(
      Uri.parse("${Urls.DELETE_OFFER_URL}${widget.userId}"),
      ...
      showModalBottomSheet(
          ...
          builder: (context) {
            return Container(
              ...
              child:
                  successOperation(operationName: "delete offer successfully"),
            );
          });
      setState(() {
        _isLoading = false;
