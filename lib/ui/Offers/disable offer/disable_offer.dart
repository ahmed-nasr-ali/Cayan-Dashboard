...
class DisableOffer extends StatefulWidget {
  int userId;
  bool is_block;
  DisableOffer({
    Key? key,
  ...
  @override
  State<DisableOffer> createState() => _DisableOfferState();
}

class _DisableOfferState extends State<DisableOffer> {
                      ...
                      child: SmallText(
                        text: widget.is_block == true
                            ? AppLocalizations.of(context)!.translate(
                                "Are you sure form Activate this offer")
                            : AppLocalizations.of(context)!
                                .translate("Are you sure form blocking offer"),
        ...
        _isLoading
            ...
            : CustomButton(
                ...
                width:
                    MediaQuery.of(context).size.width / 2.272727272727273, //165
                btnLbl: "موافق",
                onPressedFunction: disableOfferMethed,
  ...
  disableOfferMethed() async {
    ...
    final response = await put(
      Uri.parse(widget.is_block == true
          ? "${Urls.DISABLE_OFFER_URL}${widget.userId}/active"
          : "${Urls.DISABLE_OFFER_URL}${widget.userId}/block"),
            ...
            return Container(
              ...
              child: successOperation(
                  operationName: widget.is_block == true
                      ? "activate offer successfully"
                      : "ban offer successfully"),
            );
          });
      setState(() {
        _isLoading = false;
