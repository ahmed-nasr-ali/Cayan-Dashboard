// ignore_for_file: prefer_final_fields, unused_field, prefer_interpolation_to_compose_strings, non_constant_identifier_names, prefer_const_constructors, unused_local_variable, unused_element, use_build_context_synchronously, unnecessary_brace_in_string_interps, prefer_const_literals_to_create_immutables, sized_box_for_whitespace
...
import 'package:cayan/ui/News/add%20news/add_news.dart';
import 'package:cayan/ui/News/news%20setting/news_setting.dart';
...
class _NewsScreenState extends State<NewsScreen> {
                ...
                child: GestureDetector(
                  onTap: () {
                    settingNews(
                      ...
                      searchController.text == ""
                          ? _allUsers[index]["link"] ?? ""
                          : _searchedResult[index]["link"] ?? "",
                      ...
                      searchController.text == ""
                          ? _allUsers[index]["is_active"] ?? ""
                          : _searchedResult[index]["is_active"] ?? "",
  ...
  searchUserApicall(String value) async {
    ...
    final response = await clientApi.get(
        Uri.parse(
          "${Urls.GET_NEWS_URL}${searchPage}&name=${value}",
        ),
        headers: <String, String>{
          'Accept': 'application/json',
          "Accept-Language": UserData.getUSerLang(),
  ...
  void _SearchMore() async {
    ...
    if (_hasNextPage == true &&
      ...
      final response = await clientApi.get(
          Uri.parse(
            "${Urls.GET_NEWS_URL}${searchPage}&name=${searchContent}",
          ),
          headers: <String, String>{
            'Accept': 'application/json',
            "Accept-Language": UserData.getUSerLang(),
