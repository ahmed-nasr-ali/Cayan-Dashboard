...
class DisableNews extends StatefulWidget {
  int userId;
  bool is_block;
  DisableNews({
    Key? key,
  ...
  @override
  State<DisableNews> createState() => _DisableNewsState();
}

class _DisableNewsState extends State<DisableNews> {
                      ...
                      child: SmallText(
                        text: widget.is_block == true
                            ? AppLocalizations.of(context)!.translate(
                                "Are you sure form Activate this new")
                            : AppLocalizations.of(context)!
                                .translate("Are you sure form blocking new"),
  ...
  disableOfferMethed() async {
    ...
    final response = await put(
      Uri.parse(widget.is_block == true
          ? "${Urls.DELETE_NEWSR_URL}${widget.userId}/active"
          : "${Urls.DELETE_NEWSR_URL}${widget.userId}/block"),
            ...
            return Container(
              ...
              child: successOperation(
                operationName: widget.is_block == true
                    ? "activate new successfully"
                    : "ban new successfully",
              ),
            );
          });
      setState(() {
