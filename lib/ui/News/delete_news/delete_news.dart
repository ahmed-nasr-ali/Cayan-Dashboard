// ignore_for_file: must_be_immutable, unused_local_variable, prefer_final_fields, prefer_const_constructors, use_build_context_synchronously
...
class _DeleteNewsState extends State<DeleteNews> {
                  ...
                  : Center(
                      child: SmallText(
                        text: AppLocalizations.of(context)!
                            .translate("Are you sure form deleting News"),
  ...
  deleteNews() async {
    ...
    final response = await delete(
      Uri.parse("${Urls.DELETE_NEWSR_URL}${widget.id}"),
      ...
      showModalBottomSheet(
          ...
          builder: (context) {
            return Container(
              ...
              child:
                  successOperation(operationName: "Delete News successfully"),
            );
          });
      setState(() {
        _isLoading = false;
