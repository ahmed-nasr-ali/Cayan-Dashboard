// ignore_for_file: no_leading_underscores_for_local_identifiers, unused_local_variable, file_names, unused_field, prefer_final_fields, unused_element, avoid_print, use_build_context_synchronously, unnecessary_brace_in_string_interps, non_constant_identifier_names, prefer_const_literals_to_create_immutables, prefer_const_constructors, prefer_interpolation_to_compose_strings, sized_box_for_whitespace
...
import 'package:cayan/ui/Categories/add%20categories/add_categories.dart';
import 'package:cayan/ui/Categories/setting%20cartegory/setting_cartegory.dart';
...
class _CategoryScreenState extends State<CategoryScreen> {
  ...
  searchUserApicall(String value) async {
    ...
    print("${Urls.GRT_TEAM_WORK_URL}${searchPage}&name=${value}");
    final response = await clientApi.get(
        Uri.parse(
          "${Urls.GET_CATEGORIES_URL}${searchPage}&name=${value}",
        ),
        headers: <String, String>{
          'Accept': 'application/json',
          "Accept-Language": UserData.getUSerLang(),
  ...
  void _SearchMore() async {
    ...
    if (_hasNextPage == true &&
      ...
      print("${Urls.GET_CATEGORIES_URL}${searchPage}&name=${searchContent}");
      final response = await clientApi.get(
          Uri.parse(
