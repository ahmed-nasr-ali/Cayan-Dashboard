// ignore_for_file: unused_field, prefer_final_fields, unused_local_variable, prefer_const_literals_to_create_immutables, prefer_const_constructors, nullable_type_in_catch_clause, avoid_print, non_constant_identifier_names, no_leading_underscores_for_local_identifiers, sized_box_for_whitespace, prefer_if_null_operators, unnecessary_string_interpolations, use_build_context_synchronously, unnecessary_brace_in_string_interps
...
class _AddCategoriesState extends State<AddCategories> {
                  ...
                  Column(
                    ...
                    children: [
                          ...
                          : Padding(
                              ...
                              child: SmallText(
                                text: AppLocalizations.of(context)!.translate(
                                  "Fill in the following data to create a new category",
                                ),
                                size: MediaQuery.of(context).size.height /
                                    58, //14
                              ),
                      ...
                      _isLoading
                          ...
                          : _addCategoryPhoto(themeProvider),
                      SizedBox(
                      ...
                      _isLoading
                          ...
                          : Padding(
                              ...
                              child: CustomTextField(
                                ...
                                isSuffix: false,
                                isSuffixImage: false,
                                hintText: "internal medicine doctor",
                                inputData: TextInputType.name,
                                validationFunc: (value) {
                                  if (value!.isEmpty) {
                                    setState(() {
  ...
  _addCategoryPhoto(ThemeProvider themeProvider) {
          ...
          _isLoading
              ...
              : CustomButton(
                  ...
                  width: MediaQuery.of(context).size.width /
                      2.272727272727273, //165
                  btnLbl: "حفظ",
                  onPressedFunction: addCategoryMethod,
  ...
  addCategoryMethod() async {
    ...
    if (formKey.currentState!.validate()) {
      ...
      FormData formData = FormData.fromMap({
        ...
        "en[description]": _categoreNameEnglish.text,
              ...
              builder: (context) {
                return Container(
                  ...
                  child: successOperation(
                      operationName: "add new category successfully"),
                );
              });
        });
        setState(() {
