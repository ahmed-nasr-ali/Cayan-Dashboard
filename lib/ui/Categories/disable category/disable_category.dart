// ignore_for_file: must_be_immutable, avoid_print, prefer_final_fields, unused_field, prefer_const_constructors, unused_local_variable, use_build_context_synchronously, non_constant_identifier_names
...
class DisableCategory extends StatefulWidget {
  int userId;
  bool is_block;
  DisableCategory({
    Key? key,
  ...
  @override
  State<DisableCategory> createState() => _DisableCategoryState();
}

class _DisableCategoryState extends State<DisableCategory> {
                    ...
                    child: SmallText(
                      text: widget.is_block == true
                          ? AppLocalizations.of(context)!.translate(
                              "Are you sure form Activate this category")
                          : AppLocalizations.of(context)!
                              .translate("Are you sure form blocking category"),
        ...
        _isLoading
            ...
            : CustomButton(
                ...
                width:
                    MediaQuery.of(context).size.width / 2.272727272727273, //165
                btnLbl: "موافق",
                onPressedFunction: disableCategoryMethed,
  ...
  disableCategoryMethed() async {
    ...
    print("${Urls.DISABLE_Category_URL}${widget.userId}/block");
    final response = await put(
      Uri.parse(widget.is_block == true
          ? "${Urls.DISABLE_Category_URL}${widget.userId}/active"
          : "${Urls.DISABLE_Category_URL}${widget.userId}/block"),
            ...
            return Container(
              ...
              child: successOperation(
                  operationName: widget.is_block == true
                      ? "Activate category successfully"
                      : "ban category successfully"),
            );
          });
      setState(() {
        _isLoading = false;
            ...
            return AlertDialog(
              ...
              title: BigText(
                ...
                text: AppLocalizations.of(context)!
                    .translate("can not disable this category"),
                typeOfFontWieght: 1,
              ),
            );
          });
