// ignore_for_file: prefer_final_fields, unused_field, must_be_immutable, prefer_const_literals_to_create_immutables, non_constant_identifier_names, unnecessary_string_interpolations, prefer_interpolation_to_compose_strings, prefer_adjacent_string_concatenation, no_leading_underscores_for_local_identifiers, unused_local_variable
...
class ProfilesBottomSheet extends StatefulWidget {
  ...
  @override
  State<ProfilesBottomSheet> createState() => _ProfilesBottomSheetState();
}

class _ProfilesBottomSheetState extends State<ProfilesBottomSheet> {
            ...
            Row(
              children: [
                SmallText(
                  ...
                  typeOfFontWieght:
                      _addRolesAndPerimissonsProvider.categoryID.contains(
                    widget.profilesdata[index]["id"] ?? 0,
                  )
                          ? 1
                          : 0,
                  color: themeProvider.isDarkMode ? whiteColor : blackColor,
